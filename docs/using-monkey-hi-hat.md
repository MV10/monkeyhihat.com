...
* Windows: Start the program with the _Monkey Hi Hat_ icon from your Start Menu or Desktop
* Linux desktops: Start the program with the _Monkey Hi Hat_ icon from your freedesktop-aware launcher
* Linux terminal: Run the `mhh` program in the app directory under your home directory (ie. `cd ~/monkeyhihat; ./mhh`)
